...
//        WebElement headerItemContact = driver.findElement(By.xpath("//header//ul/li/a[@href='contact.html'][1]"));
        ...
        WebElement displayedImage1 = driver.findElement(By.xpath("//*[@class='benefit-icon'][1]")); //  //*[@class='benefit-icon']/span[@class='icons-benefit icon-practise']
        WebElement displayedImage2 = driver.findElement(By.xpath("//*[@class='benefit-icon']/span[@class='icons-benefit icon-custom'][1]"));
        WebElement displayedImage3 = driver.findElement(By.xpath("//*[@class='benefit-icon']/span[@class='icons-benefit icon-multi'][1]"));
        WebElement displayedImage4 = driver.findElement(By.xpath("//*[@class='benefit-icon']/span[@class='icons-benefit icon-base'][1]"));
        ...
        List<WebElement> iconTextsWebElement = driver.findElements(By.xpath("//*[@class='benefit-txt']"));
        ...
        WebElement mainContentHeader = driver.findElement(By.xpath("//div[@class='main-content']/h3[@class='main-title text-center']"));
...
//        String iframeIRL = iframeCenter.getAttribute("src");
//        driver.navigate().to(iframeIRL);
        driver.switchTo().frame(iframeCenter);
        Assert.assertTrue(driver.findElement(By.xpath("//img[@src='images/Logo_Epam_Color.svg']")).isDisplayed());
...
//        driver.navigate().to(BASE_URL);
        ...
        // Text is displayed and equals to expected result
        Assert.assertTrue(driver.findElement(By.xpath("//div[@class='main-content']/h3[@class='text-center']")).isDisplayed());
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//ul[@class='sidebar-menu left']")).isDisplayed());
